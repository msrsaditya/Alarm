...
class AlarmViewModel(private val repository: AlarmRepository, private val scheduler: AlarmScheduler) : ViewModel() {
    ...
    fun addAlarm(hour: Int, minute: Int, label: String, isActive: Boolean, daysOfWeek: List<Int>, ringtone: String = "Default", vibrate: Boolean = true, snoozeDuration: Int = 5, missions: List<com.example.data.MissionConfig> = emptyList(), mutePeriodSecs: Int = 60) {
